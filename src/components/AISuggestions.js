      ...
      <div className="card-gradient p-6 rounded-xl text-white hover-scale">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="text-right">
            <p className="text-2xl font-bold">${cardData.balance.toLocaleString()}</p>
            <p className="text-white/70 text-sm">{cardData.currency} Balance</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mt-6">
          <div className="bg-white/10 rounded-lg p-3">
            ...
            <p className="text-lg font-semibold">${cardData.monthlySpending.toLocaleString()}</p>
          </div>
          <div className="bg-white/10 rounded-lg p-3">
            <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-lg font-semibold">${cardData.availableCredit.toLocaleString()}</p>
          </div>
        </div>
      </div>
